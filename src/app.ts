...
const custom_schema = z.object({
  overwrite: z
    .boolean()
    .default(false)
    .describe("Whether to overwrite existing annotation file"),
  target: node
    .fsPathExists(true, ".", ["directory", "file"])
    .optional()
    .describe(
      "Specific file or directory to process, otherwise all files in bucket will be processed",
    ),
  annotationDataDir: node
    .fsPathExists(true, ".", "directory")
    .default("./annotation-data")
    .describe("Directory to save annotation data"),
